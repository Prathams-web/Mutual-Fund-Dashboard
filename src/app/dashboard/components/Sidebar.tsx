...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 min-h-screen w-64 bg-base border-r border-stroke p-4 flex flex-col z-50 transform transition-transform duration-300 ease-in-out
      ...
      {!isOpen && (
        <button
          className="fixed bottom-6 left-6 md:hidden z-50  p-3 rounded-full shadow-lg hover:bg-brand-accent transition-colors"
